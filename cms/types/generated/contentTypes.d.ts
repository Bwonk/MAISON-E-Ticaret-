...
export interface ApiEditorialQuoteEditorialQuote
  extends Struct.SingleTypeSchema {
  collectionName: 'editorial_quotes';
  info: {
    displayName: 'EditorialQuote';
    pluralName: 'editorial-quotes';
    singularName: 'editorial-quote';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::editorial-quote.editorial-quote'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHeroMediaHeroMedia extends Struct.SingleTypeSchema {
  collectionName: 'hero_medias';
  info: {
    displayName: 'HeroMedia';
    pluralName: 'hero-medias';
    singularName: 'hero-media';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::editorial-quote.editorial-quote': ApiEditorialQuoteEditorialQuote;
      'api::footer-setting.footer-setting': ApiFooterSettingFooterSetting;
      'api::gallery.gallery': ApiGalleryGallery;
      'api::hero-media.hero-media': ApiHeroMediaHeroMedia;
